        ...
        <div v-else-if="car" class="backdrop-blur-xl/30 bg-white/90 border border-amber-200/70 shadow-xl rounded-2xl p-8 md:p-12 animate-fade-in">
          <div class="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div class="space-y-4">
              ...
              <div class="pt-4">
                <router-link :to="{ name: 'bookingDetails', params: { id: car.carId }, query: { location: 'City or airport', from: '2025-01-01', to: '2025-01-03' } }"
...
import { fetchCarById } from '@/services/carService.js';
